...
//     e.preventDefault()
//     try {
//       const post = axios.post(`${process.env.REACT_APP_LOCAL_F_URL}/api/user/post/product/data/${localStorage.getItem('id')}`, formData, {        
//         headers: {
...
//               <input type="number" onChange={handelSetProductData} required autoComplete='off' min={1} name='lenght' placeholder='*ENTER THE LENGHT' />
//               <input type="number" onChange={handelSetProductData} required autoComplete='off' min={1} name='combo' placeholder='*ENTER THE COMBO' />
//               <textarea name="des" onChange={handelSetProductData} required autoComplete='off' rows={10} maxLength={150} placeholder='*WRITE DESCRIPTION IN 150 CHARECTOR'></textarea>
//               <p>*Select products image</p>
//               <input type="file" accept=".jpg,.jpeg,.png,.gif" name='productsImage' onChange={(e) => {
...
//                 <button>RESET</button>
//                 <button onClick={handelPostProductData}>POST</button>
//               </div>
//             </fieldset>
//           </form>
//         </main>
